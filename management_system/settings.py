...
SECRET_KEY = 'django-insecure-)1iugae#(c#29@2+bm4oz_0e02x((p*h4h8tad4o_$^%kah81)'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'studentdb',        # Name of the database you created
        'USER': 'postgres',  # Your PostgreSQL username
        'PASSWORD': 'ruilova',  # Your PostgreSQL password
